...
export function sourceRefinementProfile(
  env: Pick<Env, "OPENAI_API_KEY" | "OPENAI_REFINEMENT_MODEL">,
): SourceRefinementProfile | null {
  return env.OPENAI_API_KEY && env.OPENAI_REFINEMENT_MODEL
    ? {
        model: env.OPENAI_REFINEMENT_MODEL,
