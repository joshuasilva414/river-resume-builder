...
Actual 390-pixel light/dark proposal review now passes. Commit `61c0ac9` corrects focus return after opening and closing a queue record; local and hosted checks pass. See `mobile-review.md`. Synthetic fixture data does not establish candidate qualifications or the real Owner tailoring release gate.
