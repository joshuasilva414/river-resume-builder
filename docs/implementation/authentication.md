...
Updated 2026-09-05. River uses request-scoped Better Auth 1.7.2 with the D1 Drizzle adapter. Only the configured, verified Owner can obtain an application principal. GitHub OAuth remains a required V1 method pending the prepared personal-account registration approval.
