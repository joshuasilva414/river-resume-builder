/** Frozen v1 definitions used only to recognize unchanged saved built-ins. */
import type { ContentSchema, ContentSchemaField, SchemaBundle } from "./content-schema";
...
export const builtInSchemaBundleV1: SchemaBundle = {
  version: 2,
